...
import { getAllFaculty } from '../../features/adminSlice'
...
const AdminGetAllFaculty = () => {
    ...
    const formHandler = async (e) => {
        ...
        const response = await fetch(`${url}/api/admin/getAllFaculty`, {
            method: 'POST',
        ...
        if (response.ok) {
            ...
            setIsLoading(false)
            setDepartment('')
            dispatch(getAllFaculty(json.result))
        }
    }
    useEffect(() => {
                ...
                <div className="container">
                    <div className="row mt-5">
                        <div className="col-md-4">
                            <form form-inline="true" noValidate onSubmit={formHandler}>
